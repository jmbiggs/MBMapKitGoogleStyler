#
# Be sure to run `pod lib lint MBMapKitGoogleStyler.podspec' to ensure this is a
...
Blog post here: https://medium.com/@ortizfernandomartin/customize-mapkits-mkmapview-with-google-maps-styling-wizard-a5dcc095e19f#.zgj20kkvk
  ...
  s.author           = { 'jmbiggs' => 'eraserhead@gmail.com' }
  s.source           = { :git => 'https://github.com/jmbiggs/MBMapKitGoogleStyler.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'MBMapKitGoogleStyler/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MBMapKitGoogleStyler' => ['MBMapKitGoogleStyler/Assets/*.png']
  # }
